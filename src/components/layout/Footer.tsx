            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row">
              ...
              >
                <div className="bg-brand-orange hover:bg-brand-orange flex h-12 items-center gap-2 rounded-xl px-4 transition-all">
                  ...
                  <div className="text-left">
                    <div className="text-[10px] text-white/90">GET IT ON</div>
                    <div className="text-sm font-semibold text-white">
                      Google Play
                    </div>
                  </div>
          ...
          <div>
            ...
            <form onSubmit={handleSubscribe} className="relative">
              <input
                ...
                required
                className="h-12 w-full rounded-xl border border-white/40 bg-transparent px-4 pr-14 text-sm text-white placeholder-gray-500 focus:border-orange-500 focus:outline-none"
              />
              <button
                type="submit"
