      ...
      <div className="grid grid-cols-1 gap-5 sm:gap-6 xl:grid-cols-2">
        <div className="space-y-5 sm:space-y-6">
          <ComponentCard title="Video Ratio 16:9">
            <YouTubeEmbed videoId="6okWeNmrb2M" />
          </ComponentCard>
          <ComponentCard title="Video Ratio 4:3">
            <YouTubeEmbed videoId="6okWeNmrb2M" aspectRatio="4:3" />
          </ComponentCard>
        </div>
        <div className="space-y-5 sm:space-y-6">
          <ComponentCard title="Video Ratio 21:9">
            <YouTubeEmbed videoId="6okWeNmrb2M" aspectRatio="21:9" />
          </ComponentCard>
          <ComponentCard title="Video Ratio 1:1">
            <YouTubeEmbed videoId="6okWeNmrb2M" aspectRatio="1:1" />
          </ComponentCard>
        </div>
      </div>
    </div>
