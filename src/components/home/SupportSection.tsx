  ...
  return (
    ...
    >
      <div className="bg-brand-orange relative overflow-hidden rounded-[40px] px-6 py-12 sm:px-8 sm:py-16 md:px-12 md:py-20 lg:px-16 lg:py-24">
        {/* Decorative Stars */}
        <div className="absolute top-10 end-20 hidden text-white opacity-50 lg:block">
          <svg
            width="32"
            height="32"
            viewBox="0 0 24 24"
        ...
        <div className="absolute bottom-20 start-10 hidden text-white opacity-50 lg:block">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
        ...
        <div className="relative z-10 flex flex-col items-center justify-between gap-8 lg:flex-row">
          {/* Left Content */}
          <div className="flex flex-col items-center gap-6 text-center sm:flex-row sm:gap-8 sm:text-start lg:items-start">
            {/* Icon */}
          ...
          >
            <button className="flex items-center gap-3 rounded-xl bg-white px-8 py-4 text-base font-semibold transition-all duration-300 hover:shadow-xl sm:px-10 sm:py-5 sm:text-lg">
              ...
              <span className="text-gray-900">{t("emailButton")}</span>
            </button>
          </Link>
        </div>
      </div>
