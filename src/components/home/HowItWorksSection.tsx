    ...
    <section className="relative mx-auto max-w-7xl overflow-x-clip rounded-[40px] bg-[#010949] py-16 sm:py-20 md:py-24 lg:mb-20 lg:py-28 lg:pb-80">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-12">
        ...
        <div className="mt-10 flex flex-col items-center text-center md:justify-between">
          <p className="mb-4 text-base text-white">{t("discountText")}</p>
      ...
      <div
        className={`absolute start-1/2 top-6/12 bottom-0 z-9 mx-auto hidden w-[260px] sm:w-[320px] md:w-[420px] lg:block lg:w-[380px] ${locale === "ar" ? "translate-x-1/2" : "-translate-x-1/2"}`}
      >
